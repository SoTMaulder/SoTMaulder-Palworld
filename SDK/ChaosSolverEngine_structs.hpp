...
{
public:
	uint8                                        Pad_1E6B[0x40];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_1E6C[0x40];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_1E6D[0x40];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
