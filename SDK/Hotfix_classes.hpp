...
{
public:
	uint8                                        Pad_EC9[0x1D0];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_ED4[0x60];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_EDB[0x23];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_EDC[0x26];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_EDF[0x58];                                     // Fixing Size Of Struct [ Dumper-7 ]
