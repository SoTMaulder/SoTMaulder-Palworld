...
{
public:
	uint8                                        Pad_1B07[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1B08[0xC];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_1B1D[0xC];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
