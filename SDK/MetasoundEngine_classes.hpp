...
{
public:
	uint8                                        Pad_1A08[0x68];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1A1C[0x198];                                   // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1A21[0x68];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1A25[0xC];                                     // Fixing Size Of Struct [ Dumper-7 ]
