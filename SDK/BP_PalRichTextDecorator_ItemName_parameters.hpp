...
struct UBP_PalRichTextDecorator_ItemName_C_GetTextStringInternal_Params
{
public:
	...
	class FText                                  CallFunc_GetItemName_outName;                      // 0x20(0x18)(None)
...
struct UBP_PalRichTextDecorator_ItemName_C_GetTagName_Params
{
public:
