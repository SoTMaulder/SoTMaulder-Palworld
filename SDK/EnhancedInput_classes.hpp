...
public:
	...
	uint8                                        Pad_16E9[0x7];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_17A5[0x1A0];                                   // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_17AE[0xA0];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_17AF[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_18C1[0x5];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_18C6[0x30];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_18E8[0x3];                                     // Fixing Size Of Struct [ Dumper-7 ]
